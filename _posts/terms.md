...
id: "https://rustlogs.com/terms/index.html"
...
name: "Terms"
permalink: "https://rustlogs.com/terms/index.html"
rating: "general"
...
url: "https://rustlogs.com/terms/index.html"
viewport: "width=device-width, initial-scale=1, shrink-to-fit=no"

# RSS - The RSS feed front matter (YAML).

atom_link: "https://rustlogs.com/terms/rss.xml"
category: "Technology"
...
item_guid: "https://rustlogs.com/terms/rss.xml"
item_link: "https://rustlogs.com/terms/rss.xml"
...
twitter_url: "https://rustlogs.com/terms/index.html"

# Humans.txt - The Humans.txt front matter (YAML).

author_website: "https://rustlogs.com/terms/index.html"
...
the website located at <https://rustlogs.com/> (the "Website").
...
remain the exclusive property of RustLogs (RLG). This Website is protected
by United States and international copyright, trademark, and other laws.

### Links to Other Sites and to the RustLogs (RLG) Site

Our Website may contain links to third-party Web sites ("Linked Sites") or
services that are not owned or controlled by RustLogs (RLG). These Linked
Sites are provided solely as a convenience to our visitors.

RustLogs (RLG) has no control over and assumes no responsibility for the
...
RUSTLOGS (RLG) DOES NOT PROMISE THAT THE SITE OR ANY CONTENT, SERVICE OR
...
RUSTLOGS (RLG) CANNOT ENSURE THAT ANY FILES OR OTHER DATA YOU DOWNLOAD FROM
THE SITE WILL BE FREE OF VIRUSES OR CONTAMINATION OR DESTRUCTIVE FEATURES.
RUSTLOGS (RLG) ANY AND ALL LIABILITY FOR THE ACTS, OMISSIONS AND CONDUCT OF
ANY THIRD PARTIES IN CONNECTION WITH OR RELATED TO YOUR USE OF THE SITE AND/OR
ANY RUSTLOGS (RLG) SERVICES. IN NO EVENT SHALL RUSTLOGS (RLG), NOR ITS
...
RustLogs (RLG)’s [Privacy Policy](/privacy/index.html) applies to use of
